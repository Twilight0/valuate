...
public class Calculator : Gtk.Application
{
    ...
    public Calculator ()
    {
        Object (flags : ApplicationFlags.NON_UNIQUE, application_id : "org.x.valuate");
    ...
    private MathWindow create_new_window (Settings settings)
    {
        ...
        current_window.set_title (_("Valuate"));
    ...
    private void keyboard_shortcuts_cb ()
    {
        if (shortcuts_window == null)
        {
            ...
            try
            {
                builder.add_from_resource ("/org/x/valuate/math-shortcuts.ui");
            }
            catch (Error e)
            {
    ...
    private void help_cb ()
    {
        try
        {
            Gtk.show_uri_on_window (get_active_window (), "help:valuate", Gtk.get_current_event_time ());
        }
        catch (Error e)
        {
    ...
    private void about_cb ()
    {
        ...
        Gtk.show_about_dialog (get_active_window (),
                               ...
                               _("Valuate"),
                               "title", _("About Valuate"),
                               "version", VERSION,
                               "website", "https://github.com/Twilight0/valuate",
                               "copyright",
                               "\xc2\xa9 1986–2016 The Calculator authors\n\xc2\xa9 2026 Twilight0",
                               /* We link to MPFR and MPC which are  LGPLv3+, so Calculator cannot be conveyed as GPLv2+ */
                               "license-type", Gtk.License.GPL_3_0,
                               "comments",
                               /* Short description in the about dialog */
                               _("Valuate with financial and scientific modes."),
                               "authors", authors,
                               "documenters", documenters,
                               "translator_credits", translator_credits,
                               "logo-icon-name", "org.x.valuate");
    }
    ...
    public static int main (string[] args)
    {
        ...
        Gtk.Window.set_default_icon_name ("org.x.valuate-symbolic");
