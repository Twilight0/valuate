...
[GtkTemplate (ui = "/org/x/valuate/math-window.ui")]
public class MathWindow : Gtk.ApplicationWindow
{
    ...
    public MathWindow (Gtk.Application app, MathEquation equation)
    {
        ...
        var settings = new Settings ("org.x.valuate");
        add_action (settings.create_action ("number-format"));
        add_action (settings.create_action ("keep-history"));
        ...
        provider.load_from_resource ("/org/x/valuate/calculator.css");
