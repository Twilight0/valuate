 ...
 * license.
 */
[GtkTemplate (ui = "/org/x/valuate/math-preferences.ui")]
public class MathPreferencesDialog : Hdy.PreferencesWindow
{
    ...
    [GtkChild]
    private unowned Gtk.Switch switch_keep_history;
    ...
    construct
    {
        ...
        settings.bind ("keep-history", switch_keep_history, "active", SettingsBindFlags.DEFAULT);
